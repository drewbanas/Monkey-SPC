namespace Object
{
    ...
    class builtins
    {
        ...
        static Object len(List<Object> args) // used List<> instead of params
        {
            if (args.Count != 1)
            {
            ...
            // default:
            return newError("argument to 'len' not supported, got {0}", args[0].Type().ToString());
        }
        ...
        static Object first(List<Object> args)
        {
            ...
            {
                return newError("argument to 'first' must be ARRAY. got={0}", args[0].Type().ToString());
            }
        ...
        static Object last(List<Object> args)
        {
            ...
            if (args[0].Type() != ObjectType.ARRAY_OBJ)
            {
                return newError("argument to 'last' must be ARRAY. got={0}", args[0].Type().ToString());
            }
        ...
        static Object rest(List<Object> args)
        {
            ...
            if (args[0].Type() != ObjectType.ARRAY_OBJ)
            {
                return newError("argument to 'rest' must be ARRAY. got={0}", args[0].Type().ToString());
            }
        ...
        static Object push(List<Object> args)
        {
            ...
            if (args[0].Type() != ObjectType.ARRAY_OBJ)
            {
                return newError("argument to 'push' must be ARRAY. got={0}", args[0].Type().ToString());
            }
